...
def sac_sma_d_detalhado(area, Forcantes, Parametros, Estados=None):
    ...
    PAREA = 1 - ADIMP - PCTIM
    ############################################################################
    # FASE BACIA - INICIO DO LOOP EXTERNO
    ############################################################################
    ...
    ############################################################################
    # FASE BACIA - FIM DO LOOP EXTERNO
    ############################################################################
    ...
    QUZ_mm = DF['ROIMP'] + DF['SSUR'] + DF['SDRO'] + DF['SIF'] - DF['E4']
    QUZ = QUZ_mm*((10**-3)*(area*10**6)/86400)
