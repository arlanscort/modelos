...
def sac_sma_detalhado(parametros, PME, ETP, St=None):
    ...
    colunas_escoamentos = ['PERC','ROIMP+SDRO','SSUR','SIF','BFS','BFP','TCI']
    ...
    # UZTW - Reservatorio de agua de tensao da Zona Superior
    ...
    # LZSW - Reservatorio suplementar de agua livre da Zona Inferior
        ...
        df.loc[n,['UZTWC','UZFWC','LZTWC','LZFPC','LZFSC','ADIMC']] = UZTWC, UZFWC, LZTWC, LZFPC, LZFSC, ADIMC
        df.loc[n,['PERC','ROIMP+SDRO','SSUR','SIF','BFS','BFP','TCI']] = PERC, ROIMP+SDRO, SSUR, SIF, BFS, BFP, TCI
        n += 1
    ############################################################################
    # FIM DO LOOP EXTERNO
    ############################################################################
